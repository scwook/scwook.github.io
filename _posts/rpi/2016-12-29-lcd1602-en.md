...
---
The Wiring Pi provides [Device Driver Library](http://wiringpi.com/dev-lib/) to support some hardware. In this post, we will test to show current time on 16x2 Character LCD that is based on the Hitachi HD44780U controller. Before the test, [WiringPi]({{site.url}}/raspberrypi/2016/05/20/wiringPi-installation-en.html) must be installed.
